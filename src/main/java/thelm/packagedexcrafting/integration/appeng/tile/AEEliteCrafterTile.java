...
public class AEEliteCrafterTile extends EliteCrafterTile implements IGridHost, IActionHost {

	public boolean firstTick = true;
	public BaseGridBlock<AEEliteCrafterTile> gridBlock;
	public IActionSource source;
	public IGridNode gridNode;

	public AEEliteCrafterTile() {
		super();
