...
public class AECombinationCrafterTile extends CombinationCrafterTile implements IGridHost, IActionHost {

	public BaseGridBlock<AECombinationCrafterTile> gridBlock;
	public IActionSource source;
	public IGridNode gridNode;

	public AECombinationCrafterTile() {
		super();
