...
public class AEEnderCrafterBlockEntity extends EnderCrafterBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AEEnderCrafterBlockEntity>, IActionHost {
	...
	public AEEnderCrafterBlockEntity(BlockPos pos, BlockState state) {
		super(pos, state);
	...
	@Override
	public void onSecurityBreak(AEEnderCrafterBlockEntity nodeOwner, IGridNode node) {
		level.destroyBlock(worldPosition, true);
	}

	@Override
	public void onSaveChanges(AEEnderCrafterBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
