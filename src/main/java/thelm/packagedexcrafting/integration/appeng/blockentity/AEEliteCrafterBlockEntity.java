...
public class AEEliteCrafterBlockEntity extends EliteCrafterBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AEEliteCrafterBlockEntity>, IActionHost {

	public boolean firstTick = true;
	public IActionSource source;
	public IManagedGridNode gridNode;

	public AEEliteCrafterBlockEntity(BlockPos pos, BlockState state) {
		super(pos, state);
	...
	@Override
	public void onSecurityBreak(AEEliteCrafterBlockEntity nodeOwner, IGridNode node) {
		level.destroyBlock(worldPosition, true);
	}

	@Override
	public void onSaveChanges(AEEliteCrafterBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
