...
public class AEMarkedPedestalBlockEntity extends MarkedPedestalBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AEMarkedPedestalBlockEntity>, IActionHost {
	...
	@Override
	public void onSecurityBreak(AEMarkedPedestalBlockEntity nodeOwner, IGridNode node) {
		level.destroyBlock(worldPosition, true);
	}

	@Override
	public void onSaveChanges(AEMarkedPedestalBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
