...
public class AECombinationCrafterBlockEntity extends CombinationCrafterBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AECombinationCrafterBlockEntity>, IActionHost {

	public boolean firstTick = true;
	public IActionSource source;
	public IManagedGridNode gridNode;

	public AECombinationCrafterBlockEntity(BlockPos pos, BlockState state) {
		super(pos, state);
	...
	@Override
	public void onSecurityBreak(AECombinationCrafterBlockEntity nodeOwner, IGridNode node) {
		level.destroyBlock(worldPosition, true);
	}

	@Override
	public void onSaveChanges(AECombinationCrafterBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
	...
	public IManagedGridNode getMainNode() {
		if(gridNode == null) {
			...
			gridNode.setVisualRepresentation(CombinationCrafterBlock.INSTANCE);
