...
import thelm.packagedexcrafting.client.gui.GuiBasicCrafter;
import thelm.packagedexcrafting.container.ContainerBasicCrafter;
import thelm.packagedexcrafting.integration.appeng.networking.HostHelperTileBasicCrafter;
import thelm.packagedexcrafting.inventory.InventoryBasicCrafter;
...
public class TileBasicCrafter extends TileBase implements ITickable, IPackageCraftingMachine, IGridHost, IActionHost {
	...
	public TileBasicCrafter() {
		setInventory(new InventoryBasicCrafter(this));
		setEnergyStorage(new EnergyStorage(this, energyCapacity));
		if(Loader.isModLoaded("appliedenergistics2")) {
			hostHelper = new HostHelperTileBasicCrafter(this);
		}
	}

	@Override
	protected String getLocalizedName() {
		return I18n.translateToLocal("tile.packagedexcrafting.basic_crafter.name");
	}
	...
	public HostHelperTileBasicCrafter hostHelper;
	...
	public void readFromNBT(NBTTagCompound nbt) {
		...
		if(nbt.hasKey("Recipe")) {
			...
			if(recipe instanceof IRecipeInfoTiered && ((IRecipeInfoTiered)recipe).getTier() == 1) {
	...
	public GuiContainer getClientGuiElement(EntityPlayer player, Object... args) {
		return new GuiBasicCrafter(new ContainerBasicCrafter(player.inventory, this));
	}

	@Override
	public Container getServerGuiElement(EntityPlayer player, Object... args) {
		return new ContainerBasicCrafter(player.inventory, this);
	}
}
